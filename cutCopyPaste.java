 ...
 * @author PrasunSaxena
 */
public class cutCopyPaste extends JFrame implements ActionListener {
    ...
    public cutCopyPaste() {
        initComponents();
        setTitle("cutCopyPaste - by PrasunSaxena");
        ...
        br.addActionListener(cutCopyPaste.this);
        st.addActionListener(cutCopyPaste.this);
        re.addActionListener(cutCopyPaste.this);
    }
            ...
            if (flag) {
                ...
                Thread t = new Thread() {
                    public void run() {
                        ...
                        pb.setValue(100);
                        re.setEnabled(true);
                        JOptionPane.showMessageDialog(cutCopyPaste.this, "File Copied\nClick OK to return", "Transfer Complete", JOptionPane.PLAIN_MESSAGE);
                        refresh();
                    }
                };
                t.start();
            } else {
                JOptionPane.showMessageDialog(cutCopyPaste.this, "No flash Drive deteceted.", "Warning!", JOptionPane.PLAIN_MESSAGE);
                refresh();
            }
        }
        if (evt.getSource() == re) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cutCopyPaste.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        cutCopyPaste ctf = new cutCopyPaste();
